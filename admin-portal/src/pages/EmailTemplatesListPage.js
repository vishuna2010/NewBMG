...
const EmailTemplatesListPage = () => {
  ...
  if (loading) return <MainLayout pageTitle="Email Templates"><p>Loading email templates...</p></MainLayout>;
  if (error && templates.length === 0) return <MainLayout pageTitle="Email Templates"><p style={{ color: 'red' }}>Error fetching email templates: {error}</p></MainLayout>;
